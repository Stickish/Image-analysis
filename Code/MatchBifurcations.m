function [total_bif, matches] = MatchBifurcations(img_1, img_orig_1, img_bin_1, img_skel_1, empty_blocks_1,...
...
img_norm_1 = NormalizeImage(img_orig_1);
img_norm_2 = NormalizeImage(img_orig_2);
...
fig_bifmatch = figure('visible', 'off');
name_1 = char(img_1);
name_2 = char(img_2);
img_1 = char(img_1);
db = img_1(1:10);
...
showMatchedFeatures(img_orig_1, img_orig_2, matches_1, matches_2, 'montage');
