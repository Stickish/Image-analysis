...
% Chose the two images to match
img_1 = "Data/DB4_B/101_2";
img_2 = "Data/DB4_B/101_2";

% Specify block size w
w = 20;

% print = true if the program should display and save all images
print = true;
...
saveas(fig, 'Data/DB1_B/Images/heat_bif_1.png');

fig2 = figure;
fig2.Position = [100 100 1000 1000];
heatmap(validations_end_1, 'Colormap', flipud(autumn));
saveas(fig2, 'Data/DB1_B/Images/heat_end_1.png');
...
saveas(fig, 'Data/DB2_B/Images/heat_bif_2.png');

fig2 = figure;
fig2.Position = [100 100 1000 1000];
heatmap(validations_end_2, 'Colormap', flipud(autumn));
saveas(fig2, 'Data/DB2_B/Images/heat_end_2.png');
...
saveas(fig, 'Data/DB3_B/Images/heat_bif_3.png');

fig2 = figure;
fig2.Position = [100 100 1000 1000];
heatmap(validations_end_3, 'Colormap', flipud(autumn));
saveas(fig2, 'Data/DB3_B/Images/heat_end_3.png');
...
saveas(fig, 'Data/DB4_B/Images/heat_bif_4.png');

fig2 = figure;
fig2.Position = [100 100 1000 1000];
heatmap(validations_end_4, 'Colormap', flipud(autumn));
saveas(fig2, 'Data/DB4_B/Images/heat_end_4.png');